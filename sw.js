...
// Версия кеша поднята до v12 (релиз 10.0.11): убрана синяя подсветка/outline
// при тапе и клике по кнопкам и другим интерактивным элементам, исправлено
// мелькание старого аватара/подзаголовка при переключении на личный чат —
// style.css и app.js изменились, кеш нужно обновить.
const CACHE_NAME = 'iskra-shell-v12';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
