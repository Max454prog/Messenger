...
// Версия кеша поднята до v10 (релиз 10.0.9): в интерфейсе теперь отображается
// номер версии приложения — index.html, app.js и style.css изменились,
// поэтому кеш нужно обновить, иначе часть пользователей ещё долго получала бы
// из кеша старую версию без этих изменений.
