...
// Версия кеша поднята до v17 (релиз 10.2.0): в настройках появилась вкладка
// "Обновление и безопасность" — ручная проверка обновлений, накапливаемая
// история релизов с разворачиваемыми заметками ("что нового") по стрелке и
// кнопка "Обновить всё" для установки скачанного обновления одним нажатием.
// app.js и index.html изменились, кеш нужно обновить.
const CACHE_NAME = 'iskra-shell-v17';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
