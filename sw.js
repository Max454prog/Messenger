...
// Версия кеша поднята до v19 (релиз 10.3.1): переработана вкладка настроек
// «Обновление и безопасность» (плавная анимация карточек, время последней
// проверки, точка-уведомление на самой вкладке) и исправлен баг с точкой,
// которая раньше никогда не гасла. app.js, index.html и style.css изменились,
// кеш нужно обновить.
const CACHE_NAME = 'iskra-shell-v19';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
