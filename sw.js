...
// Версия кеша поднята до v20: исправлен баг мерцания статуса "в сети"/
// "не в сети" на слабых устройствах при включённой умной оптимизации
// (heartbeat раз в 45с почти вплотную подходил к 50-секундному таймауту
// офлайна — теперь таймаут увеличен до 70с). app.js изменился, кеш нужно
// обновить.
const CACHE_NAME = 'iskra-shell-v20';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
