...
// Версия кеша поднята до v15 (релиз 10.1.2): индикатор "печатает…" теперь
// сам обновляет метку времени в Firestore, пока человек печатает без пауз
// дольше нескольких секунд (раньше он мог погаснуть у собеседника посреди
// длинного сообщения); в HTML добавлены maxlength на никнейм/сообщение/
// название группы, согласованные с лимитами в firestore.rules — app.js и
// index.html изменились, кеш нужно обновить.
const CACHE_NAME = 'iskra-shell-v15';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
