...
// Версия кеша поднята до v11 (релиз 10.0.10): чат поддержки стал read-only
// (новости/обновления/исправления), добавлена оптимизация для слабых ПК,
// ноутбуков и телефонов (меньше частиц анимации, ленивая подгрузка
// lottie-web, пауза анимации при свёрнутой вкладке) и новая раскладка
// статусов для десктопа/смартфонов — index.html, app.js и style.css
// изменились, поэтому кеш нужно обновить, иначе часть пользователей ещё
// долго получала бы из кеша старую версию без этих изменений.
const CACHE_NAME = 'iskra-shell-v11';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
