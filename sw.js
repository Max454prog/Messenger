...
// Версия кеша поднята до v18 (релиз 10.3.0): добавлена «Умная оптимизация»
// (Настройки → Чат) — авто/вкл/выкл экономия ресурсов на слабых и старых
// процессорах телефонов, ноутбуков и ПК. app.js, index.html и style.css
// изменились, кеш нужно обновить.
const CACHE_NAME = 'iskra-shell-v18';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
